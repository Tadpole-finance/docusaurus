...
To participate in the DEX Liquidity Mining program, you need to store a number of TAD and ETH in Uniswap liquidity. LP Tokens generated from providing liquidity can be locked in the staking program at [Staking Page](https://tadpole.finance/staking.html) which will then continuously generate TAD rewards.
...
1. Open [Tadpole's Uniswap page](https://uniswap.tadpole.finance)
...
4. After the transaction is successful, a number of LP tokens will be sent to your wallet. You can check your address at [Etherscan](https://etherscan.io)

### How to stake LP tokens?

You can earn TAD continuously by staking your LP tokens. Follow these steps to stake your LP tokens.

1. Go to [Staking Page](https://tadpole.finance/staking.html)
